...
<header class="navbar pcoded-header navbar-expand-lg navbar-light header-dark">
    <div class="m-header">
        ...
        <a href="javascript:void(0);" class="b-brand">
            <img src="{{ asset(config('global.roles.admin.logo')) }}" alt="" class="logo">
            <img src="{{ asset(config('global.roles.admin.logo_thumb')) }}" alt="" class="logo-thumb">
        </a>
        <a href="javascript:void(0);" class="mob-toggler"><i class="feather icon-more-vertical"></i></a>
    </div>
                ...
                <div class="dropdown">
                    ...
                    <div class="dropdown-menu profile-notification ">
                        <ul class="pro-body">
                            ...
                            <li><a href="auth-signin.php" class="dropdown-item"><i class="fas fa-circle"></i> Lock Screen</a></li>
                        </ul>
                    </div>
                </div>
            </li>
            ...
            <li>
                <div class="dropdown drp-user">
                    ...
                    <div class="dropdown-menu dropdown-menu-right profile-notification">
                        <div class="pro-head">
                            <img src="{{ $profile_pic }}" class="img-radius" alt="User-Profile-Image">
