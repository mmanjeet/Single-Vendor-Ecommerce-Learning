                ...
                <ul class="nav pcoded-inner-navbar ">
                    ...
                    <li class="nav-item pcoded-hasmenu">
                        ...
                        <ul class="pcoded-submenu">
                            ...
                            <li><a href="bc_carousel.php">Carousel</a></li>
                            <li><a href="bc_grid.php">Grid system</a></li>
                            <li><a href="bc_progress.php">Progress</a></li>
                            <li><a href="bc_modal.php">Modal</a></li>
                            <li><a href="bc_spinner.php">Spinner</a></li>
                            ...
                            <li><a href="bc_toasts.php">Toasts</a></li>
                            <li><a href="bc_extra.php">Other</a></li>
                        </ul>
                    </li>
                    <li class="nav-item pcoded-menu-caption">
